...
if(!empty($Product_name) && !empty($brand) && !empty($Category_name) && !empty($Description) && !empty($Rating))
{
    ...
    //$v = $_POST['Image'];
    $query = "insert into review_content (Product_id,Product_name,brand,Category_name,Description,Rating) values ('$Product_id','$Product_name','$brand','$Category_name','$Description','$Rating')";
    echo $query;
